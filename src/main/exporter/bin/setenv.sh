...
declare -a datatypes="ssm_open,ssm_controlled,sgv_controlled,pexp,mirna,meth,jcn,exp,clinical,clinicalsample,cnsm,stsm"
if [ $# -eq 3 ]
then
  datatypes=$3
fi
...
export PIG_CLASSPATH="${HBASE_CONF_DIR}:${EXPORTHOMEDIR}/lib/dcc-downloader.jar:`/usr/lib/hbase/bin/hbase classpath`"
