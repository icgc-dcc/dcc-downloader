%default LIB 'lib/dcc-downloader.jar'
REGISTER $LIB
...
%default TMP_STATIC_DIR    '/tmp/download/tmp/ssm_open_static';
...
STORE static_out INTO '$TMP_STATIC_DIR' USING org.icgc.dcc.piggybank.StaticMultiStorage('$TMP_STATIC_DIR', 'simple_somatic_mutation.open', 'project_code', 'gz', '\\t');
