...
STORE static_out INTO '$TMP_STATIC_DIR' USING org.icgc.dcc.piggybank.StaticMultiStorage('$TMP_STATIC_DIR', 'simple_germline_variation.controlled', 'project_code', 'gz', '\\t');
