...
from org.icgc.dcc.data.archive import SchemaUtil
from org.icgc.dcc.piggybank import StaticMultiStorage
...
Pig.set("mapred.child.java.opts", "-Xmx8G")
...
Pig.set("pig.cachedbag.memusage", "0.4")
...
def exportDynamicData(type):
  ...
  params["LIB"] = default_exporter_src + '/../lib/dcc-downloader.jar'
  ...
  scriptDir = default_exporter_src + '/pig/' + type
