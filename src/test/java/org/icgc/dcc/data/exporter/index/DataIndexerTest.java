...
public class DataIndexerTest {
	...
	@Before
	public void setUp() {
		Mapper<Text, StreamingOutputBytesWritable, Text, StreamingOutputBytesWritable> mapper = new Mapper<Text, StreamingOutputBytesWritable, Text, StreamingOutputBytesWritable>();
		mapDriver = MapDriver.newMapDriver(mapper);
		Reducer<Text, StreamingOutputBytesWritable, Text, StreamingOutputBytesWritable> reducer = new Reducer<Text, StreamingOutputBytesWritable, Text, StreamingOutputBytesWritable>();
